...
+----------------------------+--------------------------------+---------+----------------------------------------------------------------------------------------------------+
| distributed_tree           | map[string, DistributedValues] | <empty> | Distributed values for each logged on user. The key is the name of the user these values belong to |
+----------------------------+--------------------------------+---------+----------------------------------------------------------------------------------------------------+
...
|    Field    |  Type  |  Default  |           Description            |
+=============+========+===========+==================================+
| root        | string | <not set> | Username of the distributed root |
+-------------+--------+-----------+----------------------------------+
| level       | int    | 0         |                                  |
+-------------+--------+-----------+----------------------------------+
| child_depth | int    | 0         |                                  |
...
* If the user with given ``username`` does not exist or is offline

  1. :ref:`ResetDistributed`
