class AdminMessage:
    ...
    PRIVATE_ROOM_ADD_USER_IS_OWNER = "user {} is the owner of room {}"
    ...
    PRIVATE_ROOM_OPERATOR_USER_IS_NOT_MEMBER = "user {} must first be a member of room {}"
    PRIVATE_ROOM_OPERATOR_ALREADY_OPERATOR = "user {} is already an operator of room {}"
